...
public class Request {
    ...
    public static void main(String[] args) throws Exception {
        ...
        server.createContext("/request", (HttpExchange exchange) -> {
            ...
            if ("POST".equals(exchange.getRequestMethod())) {
                ...
                String item = getJsonValue(body, "item");
                String location = getJsonValue(body, "location");

                String response = findDonation(item, location);
        ...
        server.start();
        System.out.println("Request backend running on http://localhost:8080");
    }
    ...
    private static String findDonation(String item, String location) {
